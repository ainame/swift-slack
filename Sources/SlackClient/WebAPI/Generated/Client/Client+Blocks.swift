...
extension Client {
    ...
    func blocksValidate(_ input: Operations.BlocksValidate.Input) async throws -> Operations.BlocksValidate.Output {
        try await client.send(
            input: input,
            forOperation: Operations.BlocksValidate.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/blocks.validate",
                    parameters: [],
                )
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    ...
                    let body: Operations.BlocksValidate.Output.Ok.Body
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Schemas.BlocksValidateResponse.self,
                            from: responseBody,
